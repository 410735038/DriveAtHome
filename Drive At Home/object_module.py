...
def augment(img, obj, projection, template, color=False, scale = 4):
    ...
    if(((ul_x < 140 and ul_x > 80) and (ul_y < 100 and ul_y > 60) and
       (ur_x < 520 and ur_x > 440) and (ur_y < 100 and ur_y > 60)) or
       ((lr_x < 520 and lr_x > 440) and (lr_y < 400 and lr_y > 360) and
       (ll_x < 140 and ll_x > 80) and (ll_y < 400 and ll_y > 360))):
       collision_flag = True
    #    print("obstacle!!")
